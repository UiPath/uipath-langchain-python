...
class GuardrailValidatorBase:
    ...
    - ``build_built_in_guardrail()`` for UiPath API-based validation (PII, PromptInjection)
    ...
    def evaluate(
        ...
        ``build_built_in_guardrail()`` returns ``None``.
        ...
        raise NotImplementedError(
            f"{type(self).__name__} must implement either build_built_in_guardrail() "
