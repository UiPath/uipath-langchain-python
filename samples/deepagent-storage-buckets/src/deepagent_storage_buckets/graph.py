...
from deepagent_storage_buckets.buckets_backend import UiPathBucketBackend, UiPathBucketConfig
...
deep_agent = create_deep_agent(
    model=llm,
    backend=UiPathBucketBackend(UiPathBucketConfig(bucket_name="DeepAgents", folder_path="cristian.pufu@uipath.com's workspace")),
