...
from gym_sample.utils import get_evaluation_set

from ..tools import EscalationTool
from ..uipath_gym_types import AgentBaseClass
from .tools import (
    Google,
    GoogleInput,
    LoanAgent_ApplyUiBankLoan,
    LoanAgent_ApplyUiBankLoanInput,
    LoanAgent_ModifyLoanContract,
    LoanAgent_ModifyLoanContractInput,
    LoanAgent_SendSharepointDocumentViaDocuSign,
    LoanAgent_SendSharepointDocumentViaDocuSignInput,
)
...
def get_loan_agent() -> AgentBaseClass:
    return AgentBaseClass(
        ...
        evaluation_set=get_evaluation_set(
            Path(__file__).parent / "eval-sets" / "evaluation-set-loan.json"
        ),
    )
