"""Tests for tool_factory.py - ensures all resource types produce BaseUiPathStructuredTool instances."""
...
class TestToolFactoryBaseClass:
    """Test that all possible resource types produce BaseUiPathStructuredTool instances."""
    ...
    async def test_resource_produces_base_uipath_tool(
        self, resource_fixture, mock_llm, mock_uipath_sdk, request
    ):
