...
PATCH_GET_CONFIG = "uipath_langchain._utils.durable_interrupt.decorator.get_config"
PATCH_INTERRUPT = "uipath_langchain._utils.durable_interrupt.decorator.interrupt"
