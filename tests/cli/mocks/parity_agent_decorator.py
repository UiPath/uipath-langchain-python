...
using the UiPath decorator API (@guardrail with validator strategy pattern).
Both agents are used in test_guardrails_in_langgraph.py to verify 1:1 behavioral
...
def create_llm():
    ...
    return UiPathChatOpenAI(  # type: ignore[call-arg]
