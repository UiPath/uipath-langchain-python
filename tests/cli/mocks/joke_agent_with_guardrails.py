...
custom_filter_guardrail = AgentCustomGuardrail(
...
pii_detection_guardrail = AgentBuiltInValidatorGuardrail(
...
prompt_injection_guardrail = AgentBuiltInValidatorGuardrail(
    guardrail_type="builtInValidator",
...
block_forbidden_pattern_guardrail = AgentCustomGuardrail(
    guardrail_type="custom",
...
tool_pii_detection_guardrail = AgentBuiltInValidatorGuardrail(
    guardrail_type="builtInValidator",
...
llm_pii_escalation_guardrail = AgentBuiltInValidatorGuardrail(
    guardrail_type="builtInValidator",
...
guardrails = build_guardrails_with_actions(
    [
        ...
        block_forbidden_pattern_guardrail,
        tool_pii_detection_guardrail,
        llm_pii_escalation_guardrail,
    ]
)
...
graph = create_agent(
    ...
    guardrails=guardrails,  # ← Guardrails are passed here!
)
